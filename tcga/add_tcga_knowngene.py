"""
add_tcga_knowngene.py

Appends transcript IDs to name field of the TCGA junction ID BED file output by
tcga_recount_junctions.py: one is a comma-separated list of IDs of transcripts in
which the junction is found, and the other is a comma-separated list of
corresponding gene IDs.

Requires that GTF has been downloaded via the UCSC Table Browser at; we downloaded
this GTF on June 13, 2016 as knownGene_hg38.gtf.gz, which is in
../sra/v2/hg38/ .
"""
